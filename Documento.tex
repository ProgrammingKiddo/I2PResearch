...
El principal objetivo del proyecto es proteger el anonimato de los usuarios de la red. Para esto, se utilizan una serie de servidores \textit{proxy} intermedios llamados \textit{mixers} que proporcionan múltiples
capas de seguridad a la comunicación. De forma breve, el papel de los mixer consiste en recibir un mensaje, que viene cifrado especialmente para ellos, y enviarlo al siguiente destinatario (probablemente otro mixer).
El sistema funciona y otorga anonimato por hacer irrastreable al emisor original, ya que cada \texit{mixer} solo tiene información del siguiente punto de envío, de forma que ninguno de ellos conoce
...
por tanto, destacamos los siguientes software.
...
conectandonos a puertos.

\subsection{I2PSnark[5]}

Permite conectarnos a redes p2p de forma totalmente anonima.

\subsection{Bitmessage.ch[6]}

Es un servicio de correo electrónico que permite recibir o enviar bitmessages a traves de I2P,funcinando cifrando todos los mensajes de entrada y salida
usando criptografía asimétrica de modo que solo receptor es capaz de poder descifrar el mensaje.
\\
Destacamos que permite enviar correo a traves de internet,Tor e I2P y ofrece webmail,pop3,IMAP y SMTP.  
\\

Estos son unos  ejemplos de los muchos software que existen , que usan I2P ,
