...
Tras instalar las dependencias podemos ejecutar PyBitmessage de dos,descargamos PyBitmessage y ejecutamos directamente python desde el código fuente o a través de un paquete 
